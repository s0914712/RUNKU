...
export default function GamesPage() {
  ...
  const games = [
    profile.key === 'jie' ? {
      id: 'sister-adventure',
      name: '星光單字遠征隊',
      englishName: 'THE WORDWARD EXPEDITION',
      icon: '🧭',
      description: '穿越四座探索區，以選擇、聽力和拼字挑戰姊姊的 39 個進階單字。',
      ...
      id: 'body-adventure',
      name: '奇幻身體探險記',
      englishName: 'THE MAGIC BODY ADVENTURE',
      icon: '🗺️',
      description: '走進三座魔法區域，用選擇、拼字與聽音辨位找回 14 個身體英文單字。',
